        ...
        <div className="bg-[#0f172a] min-h-screen">
            <div className="relative pt-48 pb-24 bg-[#0b1222] border-b border-white/5">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    <h1 
                        className="text-5xl md:text-7xl font-black text-white mb-8 tracking-tighter uppercase italic animate-fade-in"
                    >
                        {title}
                    </h1>
                    <div className="flex items-center justify-center gap-3 text-slate-500 text-xs font-black tracking-widest uppercase animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="container mx-auto px-6 py-40 text-center animate-slide-up">
                <div className="inline-block p-1 bg-white/5 rounded-3xl mb-12">
                     <div className="glass px-10 py-20 rounded-[2rem] border-rose-500/20">
                        ...
                        <div className="w-16 h-1 bg-rose-500 mx-auto mt-10 rounded-full animate-pulse-slow" />
                     </div>
                </div>
            </div>
        </div>
