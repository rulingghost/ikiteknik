  ...
  const projects = [
    {
      ...
      studentImg: 'https://images.unsplash.com/photo-1560250097-0b93528c311a',
    ...
    },
    {
      ...
      studentImg: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d',
    ...
    },
    {
      ...
      studentImg: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2',
    ...
    },
    {
      ...
      studentImg: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7',
    ...
    },
    {
      ...
      studentImg: 'https://images.unsplash.com/photo-1580489944761-15a19d654956',
    ...
    },
    {
      ...
      studentImg: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e',
    ...
    },
    {
      ...
      studentImg: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80',
    ...
    },
    {
      ...
      studentImg: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e',
  ...
  return (
    <div className="pt-24 pb-12 bg-gradient-to-br from-slate-50 via-white to-purple-50 min-h-screen font-sans relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        {/* Filters */}
        <div 
          className="flex flex-wrap gap-3 mb-10 border-b border-slate-200 pb-6 animate-fade-in"
        >
          ...
          {categories.map((cat, i) => (
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 shadow-md hover:-translate-y-1 hover:scale-105 active:scale-95 animate-slide-up ${
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {filteredProjects.map((project, idx) => (
              <div
                ...
                className="bg-white rounded-[1.5rem] overflow-hidden border border-slate-100 shadow-lg hover:shadow-2xl hover:-translate-y-2 hover:rotate-1 transition-all cursor-pointer group animate-scale-in"
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-2 pt-3 border-t border-slate-50">
                    <div 
                      className="w-8 h-8 rounded-full overflow-hidden border-2 border-white shadow-md hover:scale-110 transition-transform"
                    >
                      <OptimizedImage src={project.studentImg} className="w-full h-full object-cover" alt={project.student} />
                    </div>
                    ...
                    <div
                      className="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-purple-600 group-hover:text-white group-hover:rotate-45 transition-all shadow-md"
                    >
        ...
        {/* Stats */}
        <div
          className="bg-white rounded-[2rem] p-10 border border-slate-100 shadow-xl animate-fade-in"
        >
        ...
        {selectedProject && (
          <div
            ...
            className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-6 animate-modal-backdrop"
          >
            <div
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-slate-100 shadow-md">
                      <OptimizedImage src={selectedProject.studentImg} className="w-full h-full object-cover" alt={selectedProject.student} />
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-purple-50 rounded-full flex items-center justify-center text-purple-600 animate-pulse">
                      <Calendar size={20} />
                    </div>
                    <div>
                ...
                <div className="border-t border-slate-100 pt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedProject.tools.map((tool, i) => (
                      <span
                        key={i}
                        className="px-3 py-1.5 bg-slate-50 text-slate-700 rounded-lg text-xs font-bold animate-scale-in"
                        style={{ animationDelay: `${i * 0.1}s` }}
                      >
                        {tool}
                      </span>
